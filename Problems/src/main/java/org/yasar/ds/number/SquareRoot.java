...
//	http://stackoverflow.com/questions/3051602/how-do-i-compute-the-square-root-of-a-number-without-using-builtins
public class SquareRoot {

	public static void main(String[] args) {
		// Number for which square root is to be found
		//double number = Double.parseDouble(64);
	...
	/*
	 * This method finds out the square root without using any built-in
	 * functions and displays it
	 */
